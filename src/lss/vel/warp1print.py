...
def goFigures():
  ...
  for nrms in [0.0,0.5]:
    ...
    perc = 100
    #plotc(etran(e),None,None,perc=perc,png="cesu")
    #plotc(dtran(d),None,None,perc=perc,png="cdsu")
    #plotc(etran(e),s,None,perc=perc,png="cesu")
    #plotc(dtran(d),s,None,perc=perc,png="cdsu")
    plotc(etran(e),s,u,perc=perc,png="cesu")
    plotc(dtran(d),s,u,perc=perc,png="cdsu")
    #if nrms>0:
...
def plotc(c,s=None,u=None,cmin=0.0,cmax=0.0,perc=None,png=None):
  ...
  if png and pngDir:
    ...
    frame.paintToPng(720,3.33333,pngDir+"/"+png+".png")
    #frame.paintToPng(2880,3.33333,pngDir+"/"+png+".png")
