 ...
 * reflectivity image.
 * <p>
 * Also included are the forward, backward, and adjoint wavefield
...
public class WaveMigrationOperator {
  ...
  private static class LinearOperator implements CgSolver.A {
    LinearOperator(boolean useAdjoint, WaveMigrationOperator wave) {
      _adjoint = useAdjoint;
      _wave = wave;
    }
    ...
    private WaveMigrationOperator _wave;
