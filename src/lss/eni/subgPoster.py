...
#widthPoints = "smallPoster"
widthPoints = "largePoster"
...
def plot(f,cmap=gray,cmin=0,cmax=0,perc=100,sperc=None,cbar=None,cwidth=None,
  ...
  elif cbar and widthPoints=="smallPoster":
      cb.setWidthMinimum(230)
  ...
  if len(f[0])==nz:
    ...
    elif widthPoints is "largePoster":
      frame.setFontSize(40.0)
      frame.setSize(1600,1000)
    elif widthPoints is "smallPoster":
      frame.setFontSize(60.0)
  ...
  if title and savDir:
    if widthPoints is None:
      ...
      #frame.paintToPng(6000,1.0,savDir+title+'.png')
      frame.paintToPng(4800,1.0,savDir+title+'.png')
    elif widthPoints is "smallPoster":
      if len(f[0])==nz:
        frame.paintToPng(3300,1.0,savDir+title+'.png')
      else:
        frame.paintToPng(3000,1.0,savDir+title+'.png')
    else:
      frame.paintToPng(720.0,widthPoints/72.0,savDir+title+'.png')
